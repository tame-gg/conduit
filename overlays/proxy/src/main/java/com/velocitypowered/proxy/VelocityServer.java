...
public class VelocityServer implements ProxyServer, ForwardingAudience {
  ...
  public static final String VELOCITY_URL = "https://github.com/koelss/conduit";
  ...
  public ProxyVersion getVersion() {
    ...
    if (pkg != null) {
      ...
      implVendor = "Koels — fork of Velocity by PaperMC";
    } else {
      implName = "Conduit";
      implVersion = "<unknown>";
      implVendor = "Koels — fork of Velocity by PaperMC";
  ...
  private void doStartupConfigLoad() {
    try {
      ...
      if (!configuration.validate()) {
        logger.error("Your configuration is invalid. Conduit will not start up until the errors "
            + "are resolved.");
        LogManager.shutdown();
        System.exit(1);
      }
